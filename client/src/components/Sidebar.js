  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute bottom-6 w-full flex justify-center border-t border-gray-200 dark:border-gray-800 pt-4">
          <Link href="/login" onClick={() => setIsOpen(false)}>
            <FaUser className="text-2xl text-gray-700 dark:text-gray-100 hover:text-gray-900 dark:hover:text-white transition-colors" />
          </Link>
        </div>
      </aside>
