    ...
    <div className="relative w-full min-h-screen" style={{ background: 'radial-gradient(ellipse at 50% 20%, #6d28d9 0%, #18181b 60%), radial-gradient(ellipse at 80% 80%, #0f172a 0%, #18181b 80%)' }}>
      <main className="relative flex flex-col items-center justify-center px-4 py-8 z-10">
        <div className="max-w-3xl w-full bg-black rounded-2xl shadow-2xl p-8 border border-gray-800 mx-auto">
          <h1 className="text-3xl font-bold mb-4 text-white text-center">Terms of Service</h1>
          <p className="mb-6 text-gray-300 text-center">Please read our terms of service carefully.</p>
          <section className="space-y-6 text-gray-200">
            <h2 className="text-xl font-semibold text-gray-700 mb-2">Acceptance of Terms</h2>
            ...
            <h2 className="text-xl font-semibold text-gray-700 mb-2">Account Termination</h2>
            ...
            <h2 className="text-xl font-semibold text-gray-700 mb-2">Third-Party Links</h2>
            ...
            <h2 className="text-xl font-semibold text-gray-700 mb-2">Medical Disclaimer</h2>
            ...
            <h2 className="text-xl font-semibold text-gray-700 mb-2">Indemnification</h2>
            ...
            <h2 className="text-xl font-semibold text-gray-700 mb-2">Modifications to Service</h2>
            ...
            <h2 className="text-xl font-semibold text-gray-700 mb-2">Governing Law</h2>
            ...
            <p>For questions, contact us at <a href="mailto:terms@nutrilens.com" className="text-gray-700 hover:underline">terms@nutrilens.com</a>.</p>
          </section>
        </div>
      </main>
    </div>
